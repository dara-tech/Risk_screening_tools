...
export let programStageDataElements = [
    ...
    {
        id: 'Q2KRbrYIKHM',
        name: '3.Used to have sex in the past 6months?',
        formName: 'hadSexPast6Months',
        valueType: 'TEXT',
        translations: [{ property: 'NAME', locale: 'km', value: '៣.ធ្លាប់រួមភេទក្នុងរយៈពេល៦ខែចុងក្រោយដែរឬទេ?' }]
    },
    // Sort Order 2
    {
        id: 'IjncwaiwvUv',
    ...
    // Sort Order 25
    {
        ...
        valueType: 'TEXT',
        translations: [{ property: 'NAME', locale: 'km', value: '៨. តើធ្លាប់មានការព្រួយបារម្ភអំពីសុខភាពផ្លូវភេទដែរឬទេ?' }]
    },
    // Sort Order 26
    {
        id: 'eEY6HLGq5FF',
